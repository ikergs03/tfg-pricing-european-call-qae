...
{Circuito cuántico de 6 qubits reproducido a partir del paper. Se muestran compuertas de inicialización, codificación parametrizada, entrelazamiento y medición final.}
    \image{16cm}{}{fig1-circuito-paper-qhrp}
\end{figure}
...
En particular, se documentan explícitamente las librerías clave de cálculo científico,
de visualización y de computación cuántica utilizadas en los experimentos.

Para cálculo científico se emplean \texttt{numpy}, \texttt{scipy} y \texttt{pandas};
para visualización, \texttt{matplotlib} y \texttt{seaborn};
y para computación cuántica, \texttt{qiskit} y módulos asociados.

Para ejecutar el código en backend real de IBM, es necesario instalar 
\texttt{qiskit-ibm-runtime} y proporcionar credenciales válidas de IBM Quantum.
...
Esta organización permite distinguir con claridad resultados en simulación ideal, resultados en ejecución hardware y resultados de comparación con el paper, reduciendo ambiguedades en la interpretación.
