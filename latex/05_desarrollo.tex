...
Para evitar confusiones de interpretación, entre el circuito del artículo de referencia y el utilizado en el código experimental se detallan dos circuitos complementarios:
\begin{itemize}
\item \textbf{Circuito de referencia (ver Figura~\ref{FIG:CIRCUITO_PAPER_QHRP}):} replica la narrativa del artículo de referencia~\cite{arian2025qhrp} y usa CNOT como caso ilustrativo de entrelazamiento.
...
\begin{itemize}
\item \texttt{requirements\_paper\_qiskit.txt}: entorno compatible con la versión usada para reproducir el proceso del artículo de referencia~\cite{arian2025qhrp}.
...
Esta organización permite distinguir con claridad resultados en simulación ideal, resultados en ejecución hardware y resultados de comparación con el artículo de referencia~\cite{arian2025qhrp}, evitando ambigüedades en la interpretación.
