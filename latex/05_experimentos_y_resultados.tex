...
En resumen, la aportación principal de la Figura~\ref{FIG:TIME_COST} es operativa: explica de forma visual por qué QHRP tarda más y demuestra que ese patrón se repite en todas las ventanas. La limitación práctica de QHRP en este entorno es computacional, no financiera. Un coste de ~1910 s por ventana (unos 32 minutos) puede ser asumible en investigación offline, pero dificulta rebalanceos frecuentes en producción. Por tanto, para uso operativo más frecuente, hay que reducir la fase cuántica previa (aproximaciones, paralelización o hardware cuántico más eficiente).
