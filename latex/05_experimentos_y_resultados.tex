...
En consecuencia, la elección del método no es puramente técnica, sino dependiente del contexto operativo en el que se pretenda aplicar.
Esta lectura conjunta (rendimiento + coste) es la base para la discusión final del capítulo de conclusiones.
