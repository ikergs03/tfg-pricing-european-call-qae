...
En este apéndice se explica, de forma sencilla, cómo se calcula $\theta$ a partir de los datos y cómo se monta el circuito cuántico (ansatz) usado en QHRP.
...
El parámetro $\alpha$ controla la amplitud de esos ángulos. En este trabajo se usa $\alpha = 2.0$.
