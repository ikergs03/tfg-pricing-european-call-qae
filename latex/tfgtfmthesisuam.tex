...
% \bibliographyconfig{tfgtfmthesisuam}  % Descomenta cuando tengas citas
...
% Disable automatic list of equations captions (avoids raw math tokens in .loe)
\renewcommand{\eqncaption}[1]{}
...
% \thesisbibliography  % Descomenta cuando tengas al menos una \cite{} activa
