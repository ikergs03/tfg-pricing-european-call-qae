...
\palabrasclave{Computación cuántica, optimización de portafolios, Hierarchical Risk Parity, feature map, correlaciones financieras, validación experimental}
...
\input{08_apendice_estimacion_ansatz}
\input{09_apendice_fundamentos_cuantica}
