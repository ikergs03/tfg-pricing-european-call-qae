...
\advisor{Francisco Javier Gómez Arribas}
\levelin{Ingeniería Informática}
\title{Estudio de la viabilidad de la computación cuántica en aplicaciones financieras}
\subtitle{}
\author{Iker González Sánchez}
\privateaddress{C/ Francisco Tomás y Valiente Nº 11}
\copyrightdate{2026}

\dedication{A mi familia y a quienes me han acompañado durante este camino.}
\famouscite{No podemos resolver problemas\\pensando de la misma manera que cuando los creamos. \\[0.1em] \begin{flushright}Albert Einstein\end{flushright}}
...
\palabrasclave{Computación cuántica, optimización de portafolios, Hierarchical Risk Parity, mapa de características, correlaciones financieras, validación experimental}
...
\bibliographyconfig[IEEEtran]{tfgtfmthesisuam}
...
\input{02_estado_arte}
\input{03_metodologia}
\input{04_analisis_y_diseno}
\input{05_desarrollo}
\input{06_experimentos_y_resultados}
\input{07_conclusiones}

\nocite{egginger2024qkernels,wang2024optionpricing,salasperalta2012diabaticgates,nielsen2010quantumcomputation}
...
\input{08_apendice_fundamentos_cuantica}
\input{09_apendice_datos}
\input{10_apendice_estimacion_ansatz}
