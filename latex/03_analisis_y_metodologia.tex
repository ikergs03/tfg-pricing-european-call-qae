...
\begin{itemize}
    ...
    \item \textbf{Normalización de características:} Estandarización para el preprocesamiento y normalización angular min-max dentro del feature map.
\end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Normalización:} Estandarización independiente de cada característica por activo.
