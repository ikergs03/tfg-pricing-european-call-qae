...
El circuito utilizado en este trabajo puede interpretarse como un \textbf{ansatz de codificación} (feature map) diseñado para equilibrar expresividad y coste computacional. En lugar de optimizar una arquitectura arbitraria, se emplea una estructura fija y repetible de puertas de un qubit (H, T, RY, RX) y puertas de dos qubits (iSWAP) sobre pares predefinidos.
